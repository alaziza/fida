...
-- All The File By Developer Faeder : @alazizy
...
name_bot = (faederdx1:get(FAEDER..'name_bot') or 'العزايزي')
...
faederdx113(chat,msg.id_,"*✪︙هذا الملف ليس تابع لسورس العزايزي ،*")   
return false 
end      
...
faederdx(msg.chat_id_, msg.id_, 1, '✪︙*العضو* ( ['..data.first_name_..'](t.me/'..(data.username_ or 'BANDA1M')..')'..' )\n✪︙*تم رفعه ( '..faederrt..' )\n✪︙*بواسطه ( '..renk_faeder(msg)..' )*\n*', 1, 'md')
...
if fdrt == "مميز" and is_momod(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '✪︙العضو ( ['..result.title_..'](t.me/'..(text1[3] or 'BANDA1M')..')'..' )\n✪︙تم رفعه ( '..text1[2]..' )\n✪︙بواسطه ( '..renk_faeder(msg)..' )\n', 1, 'md')
...
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "BANDA1M")}}}
...
if text == 'سورس العزايزي' or text == 'سورس ديف العزايزي' or text == 'سورس انور'  then if not faederdx1:get(FAEDER..'bot:rep:mute'..msg.chat_id_) then faeder =  "تااج وباجج حبيي ، 😹🌝" else faeder = '' end faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md') end 
...
if text == 'بوت' and faeder11(msg) then  name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'العزايزي')  local faeder = {  "أسمي "..name_bot.." يعمري ",  "أسمي "..name_bot.." يقميل ",  "تره أسمي "..name_bot.." كافي بوت ",  "انت البوت لك اسمي "..name_bot.." ", }  faeder2 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faeder2] , 1, 'md')  end
if (text and text == (faederdx1:get('faeder:'..bot_id..'name_bot') or 'العزايزي')) then name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'العزايزي') local namebot = {  'عيون '..name_bot..' العسليات ؛🤭☄',  'اطلقق من يصيح '..name_bot..' ؛😻💗',  'وياك '..name_bot..' عمري أمرني 🌾' } name = math.random(#namebot) faederdx(msg.chat_id_, msg.id_, 1, namebot[name] , 1, 'md') return false end
--     By Developer Faeder     -- 
...
name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'العزايزي')
...
send_inline(msg.chat_id_,'✪︙مرحبا بك في سورس العزايزي┋FAEDER ،\n✪︙اضغط على الازرار بالاسفل ⬇️ ،',nil,inline) 
return false 
end
--     By Developer Faeder     -- 
...
faederdx1:set(FAEDER.."bot:group:link"..msg.chat_id_,(t2.invite_link_ or "@BANDA1M")) 
...
local list = faederdx1:smembers(FAEDER.."bot:groups")
local text = "~ Groups_Bots_In_the_Bot_Of_Source_Faeder ~ @BANDA1M\n\n"
for k,v in pairs(list) do
